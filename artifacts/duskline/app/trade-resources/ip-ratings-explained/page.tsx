      ...
      <div className="mx-auto px-6" style={{ maxWidth: "760px" }}>
        ...
        <div style={{ marginTop: "36px", fontSize: "1rem", color: "#C9CCD4", lineHeight: 1.85 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", margin: "28px 0" }}>
            <div style={{ padding: "18px 20px", borderRadius: "10px", border: "1px solid rgba(91,100,120,0.25)", background: "#1F222B" }}>
              <p style={{ fontWeight: 700, color: "#F4F1EA", marginBottom: "6px" }}>IP54</p>
              <p style={{ color: "#9A9DA8", lineHeight: 1.7, fontSize: "0.9375rem" }}>
            ...
            <div style={{ padding: "18px 20px", borderRadius: "10px", border: "1px solid rgba(91,100,120,0.25)", background: "#1F222B" }}>
              <p style={{ fontWeight: 700, color: "#F4F1EA", marginBottom: "6px" }}>IP65</p>
              <p style={{ color: "#9A9DA8", lineHeight: 1.7, fontSize: "0.9375rem" }}>
                Dust-tight, protected against low-pressure water jets. Better, but still not rated
                for submersion.
              </p>
            </div>
            <div style={{ padding: "18px 20px", borderRadius: "10px", border: "1px solid rgba(245,178,92,0.3)", background: "rgba(245,178,92,0.06)" }}>
