...
export const metadata: Metadata = {
  title: "Terms & Conditions — Duskline",
  description:
    "Terms and conditions for the supply of Duskline outdoor LED strip lighting products. Supply-only; installation is the customer's responsibility and must be carried out by a licensed electrician.",
...
const sections: Section[] = [
  {
    ...
    clauses: [
      {
        id: "1.1",
        text: 'Duskline ("we," "us," "our") supplies outdoor LED strip lighting products, including flexible and rigid mounting systems, LED strip, drivers, dimmers, connectors, and associated components (the "Products").',
      },
      {
        id: "1.2",
        strong:
          "Duskline is a supplier of parts only. We do not provide installation services, electrical work, or on-site trade services of any kind.",
      ...
      {
        id: "1.3",
        text: 'By purchasing Products from Duskline, the purchaser ("you," "the Customer") acknowledges and agrees that installation, wiring, electrical connection, and integration of the Products is entirely the Customer\'s responsibility, or the responsibility of whichever licensed tradesperson the Customer engages to carry out that work.',
      },
    ],
  },
  {
    ...
    clauses: [
      ...
      },
      {
        id: "2.2",
        strong:
          "Duskline strongly recommends that all electrical connection, wiring, and installation of the Products be carried out exclusively by a licensed electrician.",
      ...
      },
      {
        ...
        sub: [
          ...
          "(b) Duskline accepts no responsibility whatsoever for the outcome, safety, or compliance of any installation not carried out by a licensed electrician;",
    ...
    clauses: [
      ...
      },
      {
        ...
        sub: [
          ...
          "(d) damage or malfunction arising from modifications, alterations, or repairs made to the Products by anyone other than Duskline;",
  ...
  },
  {
    ...
    clauses: [
      {
        id: "5.1",
        text: "Duskline does not offer any additional or extended warranty beyond what is described in this clause.",
      },
      {
        id: "5.2",
        strong:
      ...
      {
        id: "5.3",
        text: "To the maximum extent permitted by law, and subject to clause 5.2, Duskline's liability for any claim arising from the Products is limited, at Duskline's option, to one of the following: (a) replacement of the Product; (b) resupply of an equivalent Product; or (c) refund of the price paid for the Product. Duskline's liability is in any event limited to the amount paid by the Customer for the specific Product giving rise to the claim.",
      },
      {
        id: "5.4",
        text: "Where the Customer is a business acquiring the Products for the purposes of a trade, business, or profession, and to the extent permitted by law, the parties agree that the guarantees under the Australian Consumer Law that can be excluded for such acquisitions are excluded, and Duskline's liability is limited as set out in clause 5.3.",
      },
      {
        id: "5.5",
  ...
  },
  {
    ...
    clauses: [
      {
        id: "6.1",
        text: "Subject to clause 5.2, and to the maximum extent permitted by law, Duskline excludes all liability (whether in contract, tort, including negligence, under statute, or otherwise) for:",
        sub: [
      ...
      {
        id: "6.2",
        text: "Nothing in these Terms excludes or limits Duskline's liability for death or personal injury caused by Duskline's own negligence, to the extent such exclusion or limitation is not permitted by law.",
      },
      {
        id: "6.3",
        text: "The Customer acknowledges that the exclusions and limitations in this clause are a fundamental basis on which Duskline is prepared to supply the Products, and that the price of the Products reflects the allocation of risk set out in these Terms.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: "7.1",
        text: "To the maximum extent permitted by law, the Customer indemnifies and holds Duskline harmless against any claim, loss, damage, cost, or expense (including legal costs) arising from or connected with:",
        sub: [
          ...
          "(c) any use of the Products otherwise than in accordance with the specifications and instructions provided by Duskline;",
  ...
  },
  {
    ...
    clauses: [
      {
        id: "8.1",
        text: "Products are made to order. Estimated lead times provided at the time of quotation (including any standard or expedited lead time) are estimates only, based on information available at the time, and are not guaranteed delivery dates unless expressly confirmed in writing by Duskline as a firm date for a specific order.",
      },
      {
        id: "8.2",
        text: "Duskline is not liable for any loss, cost, or damage arising from delay in delivery, including but not limited to costs associated with trade scheduling, project delays, or third-party contractual commitments made by the Customer in reliance on an estimated lead time.",
      },
      {
        id: "8.3",
        text: "Risk in the Products passes to the Customer on delivery to the address nominated by the Customer, or on collection, whichever occurs first. Duskline is not responsible for the Products once delivered, including any damage occurring during on-site storage, handling, or subsequent installation.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: "9.1",
        text: "Where Duskline provides a specification, quote, or recommendation based on information supplied by the Customer (including site dimensions, application type, or intended use), that specification is based solely on the information provided and Duskline has not conducted any site inspection, engineering assessment, or independent verification of site conditions.",
      },
      {
        id: "9.2",
        text: "It is the Customer's responsibility (or the responsibility of their engaged tradesperson) to verify that the specified Products are suitable for the actual site conditions, electrical supply, environmental exposure, and intended use prior to installation. Duskline is not liable for any mismatch between the specification provided and the actual requirements of the site, where that mismatch arises from inaccurate, incomplete, or changed information provided by the Customer.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: "10.1",
        text: "As Products are made to order, Duskline does not accept returns for change of mind. This clause does not affect any right the Customer has under the Australian Consumer Law in relation to a failure to meet a consumer guarantee.",
      },
    ],
  },
  {
    ...
    clauses: [
      {
        id: "11.1",
        text: "These Terms constitute the entire agreement between Duskline and the Customer in relation to the supply of the Products, and supersede any prior representations, understandings, or agreements, whether written or oral, except to the extent such representations would constitute misleading or deceptive conduct under the Australian Consumer Law.",
      },
      {
        id: "11.2",
      ...
      {
        id: "11.4",
        text: "Duskline may update these Terms from time to time. The Terms in force at the time an order is placed apply to that order.",
      },
    ],
  },
];
          ...
          <div className="mx-auto px-6" style={{ maxWidth: "820px" }}>
            ...
            >
              <p style={{ fontSize: "0.9375rem", color: "#F4F1EA", lineHeight: 1.7, fontWeight: 600 }}>
                Duskline supplies components only.
              </p>
