...
export const kits: Kit[] = [
  {
    ...
    specTable: [
      { item: "LED Strip, 24V warm white", partNumber: PART_NUMBERS.strip, details: "IP68, 10W/m, dimmable 0–10V" },
      { item: "Flexible Segmented Track", partNumber: PART_NUMBERS.flexibleTrack, details: "Horizontal bend, ground-level mount" },
      { item: "Driver, 150W", partNumber: PART_NUMBERS.driver, details: "0–10V, RCM compliant, covers up to 12m per run" },
      { item: "Dimmer, 0–10V wall control", partNumber: PART_NUMBERS.dimmer, details: "Wall-mounted, 1 per driver" },
      { item: "240V Plug & Power Cable", partNumber: PART_NUMBERS.plug, details: "Weatherproof outdoor-rated cable" },
  ...
  },
  {
    ...
    specTable: [
      { item: "LED Strip, 24V warm white (submersible)", partNumber: PART_NUMBERS.strip, details: "IP68, sealed to 1.5m/30min, 10W/m" },
  ...
  },
  {
    ...
    specTable: [
      ...
      { item: "Driver, 150W", partNumber: PART_NUMBERS.driver, details: "0–10V, RCM compliant, 1 per ~12m of run" },
      { item: "Dimmer, 0–10V wall control", partNumber: PART_NUMBERS.dimmer, details: "Wall-mounted, 1 per driver" },
      { item: "240V Plug & Power Cable", partNumber: PART_NUMBERS.plug, details: "Weatherproof outdoor-rated cable" },
